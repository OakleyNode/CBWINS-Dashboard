...
in St. Mary's County Seventh District. BOBs are built using inexpensive
...
add_selectbox = st.sidebar.selectbox(
    'Select a BOB to see its data',
    ('BOB-01', 'BOB-02', 'BOB-03', 'BOB-04', 'BOB-05', 'BOB-06', 'BOB-07', 'BOB-08',
        'BOB-09', 'BOB-10', 'BOB-11')
)

st.sidebar.checkbox('This is awesome')

with JAFCTC_sect:
    st.subheader("Dr. J.A. Forrest Career and Technology Center")
    st.markdown('Our JAFCTC BOBS are the bestest BOBs ever and pretty soon we\'ll be ' +
